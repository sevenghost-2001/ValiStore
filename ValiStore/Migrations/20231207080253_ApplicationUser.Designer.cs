...
namespace ValiStore.Migrations
{
    ...
    [Migration("20231207080253_ApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ValiStore.Models.TAnhChiTietSp", b =>
                {
            ...
            modelBuilder.Entity("ValiStore.Models.TAnhSp", b =>
                {
            ...
            modelBuilder.Entity("ValiStore.Models.TChatLieu", b =>
                {
            ...
            modelBuilder.Entity("ValiStore.Models.TChiTietHdb", b =>
                {
            ...
            modelBuilder.Entity("ValiStore.Models.TChiTietSanPham", b =>
                {
                    b.Property<string>("MaChiTietSp")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TDanhMucSp", b =>
                {
                    b.Property<string>("MaSp")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.THangSx", b =>
                {
                    b.Property<string>("MaHangSx")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.THoaDonBan", b =>
                {
                    b.Property<string>("MaHoaDon")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TKhachHang", b =>
                {
            ...
            modelBuilder.Entity("ValiStore.Models.TKichThuoc", b =>
                {
                    b.Property<string>("MaKichThuoc")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TLoaiDt", b =>
                {
                    b.Property<string>("MaDt")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TLoaiSp", b =>
                {
                    b.Property<string>("MaLoai")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TMauSac", b =>
                {
                    b.Property<string>("MaMauSac")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TNhanVien", b =>
                {
                    b.Property<string>("MaNhanVien")
                        .HasMaxLength(25)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TQuocGium", b =>
                {
            ...
            modelBuilder.Entity("ValiStore.Models.TUser", b =>
                {
                    b.Property<string>("Username")
                        .HasMaxLength(100)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("ValiStore.Models.TAnhChiTietSp", b =>
                {
                    b.HasOne("ValiStore.Models.TChiTietSanPham", "MaChiTietSpNavigation")
            ...
            modelBuilder.Entity("ValiStore.Models.TAnhSp", b =>
                {
                    b.HasOne("ValiStore.Models.TDanhMucSp", "MaSpNavigation")
                        .WithMany("TAnhSps")
                        .HasForeignKey("MaSp")
                        .IsRequired()
            ...
            modelBuilder.Entity("ValiStore.Models.TChiTietHdb", b =>
                {
                    ...
                    b.HasOne("ValiStore.Models.THoaDonBan", "MaHoaDonNavigation")
                        .WithMany("TChiTietHdbs")
            ...
            modelBuilder.Entity("ValiStore.Models.TChiTietSanPham", b =>
                {
                    b.HasOne("ValiStore.Models.TKichThuoc", "MaKichThuocNavigation")
                        .WithMany("TChiTietSanPhams")
                        .HasForeignKey("MaKichThuoc")
                        .HasConstraintName("FK_tChiTietSanPham_tKichThuoc");

                    b.HasOne("ValiStore.Models.TMauSac", "MaMauSacNavigation")
                        .WithMany("TChiTietSanPhams")
            ...
            modelBuilder.Entity("ValiStore.Models.TDanhMucSp", b =>
                {
                    b.HasOne("ValiStore.Models.TChatLieu", "MaChatLieuNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaChatLieu")
                        .HasConstraintName("FK_tDanhMucSP_tChatLieu");

                    b.HasOne("ValiStore.Models.TLoaiDt", "MaDtNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaDt")
                        .HasConstraintName("FK_tDanhMucSP_tLoaiDT");

                    b.HasOne("ValiStore.Models.THangSx", "MaHangSxNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaHangSx")
                        .HasConstraintName("FK_tDanhMucSP_tHangSX");

                    b.HasOne("ValiStore.Models.TLoaiSp", "MaLoaiNavigation")
                        .WithMany("TDanhMucSps")
                        .HasForeignKey("MaLoai")
                        .HasConstraintName("FK_tDanhMucSP_tLoaiSP");

                    b.HasOne("ValiStore.Models.TQuocGium", "MaNuocSxNavigation")
                        .WithMany("TDanhMucSps")
            ...
            modelBuilder.Entity("ValiStore.Models.THoaDonBan", b =>
                {
                    b.HasOne("ValiStore.Models.TKhachHang", "MaKhachHangNavigation")
                        .WithMany("THoaDonBans")
                        .HasForeignKey("MaKhachHang")
                        .HasConstraintName("FK_tHoaDonBan_tKhachHang");

                    b.HasOne("ValiStore.Models.TNhanVien", "MaNhanVienNavigation")
                        .WithMany("THoaDonBans")
            ...
            modelBuilder.Entity("ValiStore.Models.TKhachHang", b =>
                {
                    b.HasOne("ValiStore.Models.TUser", "UsernameNavigation")
